...
const Regalos = () => {
  ...
  return (
    <Section variant="default">
      ...
      <div className="w-full max-w-[1300px] pt-6 md:pt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 px-4 sm:px-0">
        {/* Kit "la pertenencia" - Large Card */}
        <div className="w-full  mx-auto h-96 relative flex justify-center items-start overflow-hidden">
          ...
          <div className="w-80 p-5 absolute top-8 bg-white inline-flex flex-col justify-start items-start gap-1">
        ...
        <div className="w-full mx-auto bg-white inline-flex flex-col justify-start items-center">
          ...
          <div className="self-stretch p-5 flex flex-col justify-start items-start gap-1">
            ...
            <button
              className="self-stretch pl-9 pr-7 py-1.5 bg-neutral-900 rounded-sm outline outline-[0.38px] outline-offset-[-0.38px] outline-amber-300 inline-flex justify-center items-center gap-3"
              onClick={() => handleAddToCart('Kit "1ra Copa"', quantities.kit2)}
            >
              <div className="justify-start text-amber-300 text-base font-medium font-['Lora'] uppercase tracking-[8px]">
                agregar
              </div>
        ...
        <div className="w-full mx-auto bg-white inline-flex flex-col justify-start items-center">
          ...
          <div className="self-stretch p-5 flex flex-col justify-start items-start gap-1">
            ...
            <button
              className="self-stretch pl-9 pr-7 py-1.5 bg-neutral-900 rounded-sm outline outline-[0.38px] outline-offset-[-0.38px] outline-amber-300 inline-flex justify-center items-center gap-3"
              onClick={() => handleAddToCart('Kit "2da Copa"', quantities.kit3)}
            >
              <div className="justify-start text-amber-300 text-base font-medium font-['Lora'] uppercase tracking-[8px]">
                agregar
              </div>
