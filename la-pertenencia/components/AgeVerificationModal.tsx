...
const AgeVerificationModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-80 md:w-[28rem] lg:w-[32rem] h-44 p-7 bg-neutral-50 rounded-sm flex flex-col justify-start items-start gap-2.5 overflow-hidden mx-4">
        ...
        <div className="self-stretch py-5 inline-flex justify-start items-end gap-3 md:gap-5 flex-col sm:flex-row">
          <button
