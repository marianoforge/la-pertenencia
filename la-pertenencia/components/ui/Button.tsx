...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        "max-[380px]:px-4 px-12 py-4 bg-neutral-900 rounded-sm outline outline-[0.50px] outline-offset-[-0.50px] outline-amber-300 text-amber-300 text-base hover:bg-neutral-800",
      outline:
