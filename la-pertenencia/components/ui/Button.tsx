...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "h-9 md:h-auto px-7 py-3 md:px-12 md:py-4 bg-amber-300 rounded-sm outline outline-[0.36px] md:outline-[0.50px] outline-offset-[-0.36px] md:outline-offset-[-0.50px] outline-neutral-900 text-neutral-900 text-sm md:text-base tracking-[7px] md:tracking-[8px] hover:bg-amber-400",
      secondary:
